            ...
            <td style="background-color: #004d40; padding: 24px 32px; color: #ffffff;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="right">
                    <span style="background-color: #f6821f; color: #ffffff; font-size: 11px; font-weight: 700; padding: 6px 12px; border-radius: 20px; text-transform: uppercase;">Cotización N.º ${quoteNumber}</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              ${
                notes
                  ? `
              <div style="background-color: #f8fafc; border-left: 4px solid #f6821f; padding: 12px 16px; border-radius: 4px; margin-bottom: 16px;">
